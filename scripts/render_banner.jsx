...
export default async ({ project }) => {
  ...
  const p = await project({dir: './banner-project',size:'1100x540',fps:12,background:'#090f1e'});
  ...
  p.compose(
    <frame x={0} y={0} width={1100} height={540} layout="none">
      ...
      <rect x={42} y={110} width={216} height={29} radius={14} fill="#142935" strokeColor="#2c5465" strokeWidth={1}/>
      <rect x={55} y={120} width={7} height={7} radius={4} fill="#79dfff" />
      <text x={73} y={117} width={180} height={20} fontFamily="Montserrat" fontSize={10} fontWeight={600} letterSpacing={1.8} color="#c5efff">PYTHON · BACKEND · AI</text>
    ...
    {dur:4,name:'Jaswanth 3D profile banner'}
  );
  await p.frame(1,`${root}/hero.png`);
  await p.render(`${root}/hero.mp4`,{bitrate:5000000,accel:'cpu'});

  const m = await project({dir:'./mobile-project',size:'640x850',fps:12,background:'#090f1e'});
  ...
  m.compose(
    <frame x={0} y={0} width={640} height={850} layout="none">
      ...
      <text x={30} y={248} width={580} height={30} fontFamily="Montserrat" fontSize={17} fontWeight={500} color="#aebbd1">Python Backend · AI Integration · Full-Stack</text>
    ...
    </frame>,{dur:4,name:'Mobile 3D profile banner'}
  );
